...
func main() {
	app := fiber.New(fiber.Config{
		AppName: "Praktikum Backend Lanjut - Tugas Mandiri",
	...
	// Grup khusus students yang dilindungi oleh middleware requireJSON
	...
	fmt.Println("Server API Students berjalan di http://localhost:3000")
