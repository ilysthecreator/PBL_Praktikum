...
// ParamID membaca parameter :id dari path url dan memastikan bentuknya integer positif.
...
// allowedSort membatasi nama kolom yang diizinkan untuk ORDER BY demi mencegah SQL injection.
